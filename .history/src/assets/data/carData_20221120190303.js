...
const carData = [
  {
    ...
    automatic: "Automatic",
    description:
      " Penampilan WR-V lebih terinspirasi oleh Honda BR-V daripada Jazz. Kap mesinnya kini lebih tinggi dengan lampu utama persegi yang mengapit slat tebal yang terlihat seperti kumis. Bumpernya tampak berkontur, dengan lipatan-lipatan serta plat yang menegaskan tampilan SUV yang garang.Bagian sampingnya, terutama setelah pilar A, menampilkan atap Jazz sampai ke bagian ekornya. Dilengkapi cladding dan roof rail yang memperkuat tampilan sebuah SUV.Di bagian dalamnya, WR-V tampak menyerupai Jazz, dengan tata letak dasbor, tombol telepon, konsol pusat dan setir yang sangat mirip.Walaupun perlengkapannya juga sama dengan Jazz, Honda WR-V dilengkapi sunroof yang digerakkan secara elektrik untuk mobil dengan spesifikasi tinggi, sehingga fitur-fitur yang disematkan untuknya mendekati fitur-fitur pada Honda City.Di bagian keamanan, mobil ini dilengkapi dua buah airbag di depan dan ABS yang disertai EBD yang sudah standar di semua variannya.",
  },

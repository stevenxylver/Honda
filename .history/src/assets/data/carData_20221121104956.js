...
const carData = [
...

  {
    ...
    automatic: "Automatic",
    description:
      " mesin berkode L15 bertenaga 120 PS atau sekitar 117,5 Hp yang disemburkan pada putaran mesin 6.600 rpm. Membuat akselerasinya sigap, bahkan dari diam hingga sprint ke 100 km/jam hanya butuh waktu sekitar 11 detik saja. Dengan fitur-fitur kekinian diantaranya adalah dengan penerapan touchscreen digital panel AC, serta head unit floating monitor dengan ragam fungsi.

      Carro hadir untuk memberikan pelayanan pengiriman terbaik dan teraman yang menjangkau seluruh area Indonesia. Mobil akan diantarkan sesuai dengan kota tujuan Anda..",
  },
